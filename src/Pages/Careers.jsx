...
const jobOpenings = [
  {
    ...
    location: "Diani Store",
    description:
      "Help customers, manage the sales floor, and offer excellent service.",
  },
  {
    id: 2,
    title: "Inventory Clerk",
    location: "Diani Warehouse",
    description:
      "Track stock, manage deliveries, and support restocking.",
  },
  {
    id: 3,
    ...
    description:
      "Handle customer inquiries via email, phone, and social media.",
  },
];
